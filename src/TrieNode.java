...
public class TrieNode {
    ...
    /**
     * Gets the String that this node represents. For example, if this node represents the character t, whose parent
     * represents the charater a, whose parent represents the character c, then the String would be "cat".
     * @return
     */
